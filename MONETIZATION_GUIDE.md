...
```html
<a href="/api/checkout/create?plan=setup" class="cta-button"> 🚀 White-Glove Setup - $599 </a>
```
...
https: const tenant = {
  ...
  billing: {
    plan: 'white_label',
    revenueShare: 0.3 // 30% to you, 70% to agency
  }
};
```
