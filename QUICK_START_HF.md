...
# Download models
mkdir -p ./models
huggingface-cli download "mistralai/Mistral-7B-Instruct-v0.3" --cache-dir ./models --resume-download
huggingface-cli download "microsoft/phi-2" --cache-dir ./models --resume-download
huggingface-cli download "TinyLlama/TinyLlama-1.1B-Chat-v1.0" --cache-dir ./models --resume-download
```
