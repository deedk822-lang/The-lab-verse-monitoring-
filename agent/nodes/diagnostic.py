...
Repository: {getattr(state, 'repo_full_name', 'unknown')}
Branch: {getattr(state, 'branch', 'unknown')}
Workflow: {getattr(state, 'workflow_name', 'unknown')}
Error: {getattr(state, 'error_message', 'unknown')}
