    ...
    def _ensure_model_loaded(self, model_name: str):
        ...
        if self._model is None or self._current_model_name != model_name:
            try:
                ...
                # Pass token explicitly AND use environment variable
                ...
                self._tokenizer = AutoTokenizer.from_pretrained(
                    ...
                    token=use_auth_token,  # Use token for authentication
...
class LLMProviderFactory:
    ...
    def create(provider_type: str, config: LLMConfig) -> LLMProvider:
        ...
        Args:
            provider_type: Type of provider (huggingface, zai, qwen, openai)
...
def initialize_from_env() -> LLMProvider:
    ...
    Environment Variables:
        LLM_PROVIDER: Provider type (huggingface, zai, qwen, openai)
        ...
        For Z.AI:
            ...
            ZAI_BASE_URL: Z.AI base URL (optional)
