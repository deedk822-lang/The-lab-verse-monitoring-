...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str | None = None  # Use environment variable for database URL
    ...
    # Redis
    redis_url: str | None = None  # Use environment variable for Redis URL
...
def get_settings() -> Settings:
    """Get cached settings."""
    return Settings()
export PRFIXAGENT_PASSWORD=your_password_here
export DATABASE_URL=postgresql+psycopg2://prfixagent:your_password_here@localhost:5432/pr_fix_agent