...
def main():
    ...
    validator = SecurityValidator(repo_path)  # noqa: F841
    analyzer = PRErrorAnalyzer(agent=agent)  # noqa: F841
    fixer = PRErrorFixer(agent=agent, repo_path=str(repo_path))  # noqa: F841
