...
export class FinOpsTagger {
  ...
  getAllocation() {
    /* per-tenant cost */ return {};
  }

  trackLlmUsage(tokens: number, dimensions: any) {
    if (this.client && typeof this.client.histogram === 'function') {
      try {
