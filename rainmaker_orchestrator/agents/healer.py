...
class SelfHealingAgent:
    ...
    def __init__(
        ...
        orchestrator: RainmakerOrchestrator | None = None,
    ):
        """
    ...
    def _init_orchestrator(self) -> RainmakerOrchestrator:
        ...
        """
        # Default workspace path if not otherwise specified
    ...
    def handle_alert(self, alert_payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            not alerts
            and "description" not in alert_payload
            and "service" not in alert_payload
        ):
            return {
                "status": "ignored",
                "reason": "No alerts, description or service in payload",
            }
