...
class SelfHealingAgent:
    ...
    def _init_orchestrator(self) -> RainmakerOrchestrator:
        ...
        """
        # Hardcode default workspace path to avoid settings dependency for now
    ...
    def safe_parse_command(command: str) -> list[str]:
        ...
        try:
            ...
            logger.error(f"Command parsing failed: {e!s}")
            raise
    ...
    def extract_json(response: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"JSON extraction failed: {e!s}")
            raise
