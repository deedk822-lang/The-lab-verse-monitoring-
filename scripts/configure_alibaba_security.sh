...
echo "   - ALIBABA_CLOUD_OIDC_ROLE_ARN: arn:acs:ram::<your-account-id>:role/GitHubActionsSecurityRole"
echo "   - ALIBABA_CLOUD_OIDC_PROVIDER_ARN: arn:acs:ram::<your-account-id>:oidc-provider/github-actions"
