...
class PerplexityService {
  ...
  async researchTopic(params) {
    try {
      ...
      const result = await this.generateContent({
        ...
        systemPrompt:
          'You are a research assistant that provides accurate, well-sourced information with proper citations. Always fact-check information and provide multiple perspectives when relevant.'
      });
  ...
  async generateSocialContent(params) {
    try {
      ...
      if (includeTrends) {
        prompt +=
          'Research current trends and news related to this topic and incorporate relevant insights. ';
      }
  ...
  async generateFactCheckedContent(params) {
    try {
      ...
      const result = await this.generateContent({
        ...
        systemPrompt:
          'You are a fact-checking journalist who provides accurate, well-researched content with proper citations. Always verify information with multiple sources and present balanced viewpoints.'
      });
