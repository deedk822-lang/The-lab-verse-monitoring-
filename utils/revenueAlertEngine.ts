      ...
      attachments: [
        {
          ...
          fields: [
            {
              title: 'Current MRR',
              value: `$${data.metrics.currentMrr.toLocaleString()}`,
              short: true
            },
            ...
            { title: 'Customers', value: data.metrics.customerCount.toString(), short: true },
            {
              ...
              value: `$${data.metrics.avgRevenuePerCustomer.toFixed(2)}`,
              short: true
            }
          ],
          color: 'good'
        ...
        },
        {
          ...
          fields: [
            ...
            {
              title: 'Projected Next Milestone',
              value: `$${data.projectedNextMilestone.toLocaleString()}`,
              short: true
            }
          ],
          color: 'warning'
