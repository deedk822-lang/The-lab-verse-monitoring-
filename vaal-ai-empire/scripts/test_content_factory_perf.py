...
mock_modules = {
    ...
    'api.kimi': MagicMock(KimiAPI=MockAPI),
    'api.image_generation': MagicMock(BusinessImageGenerator=MockAPI),
    'api.aya_vision': MagicMock(AyaVisionAPI=MockAPI),
}
...
class TestContentFactoryPerformance(unittest.TestCase):
    ...
    def test_instantiation_performance_improvement(self):
        ...
        self.assertGreater(improvement_factor, 10, "The caching optimization is not effective enough.")

if __name__ == '__main__':
    print("=" * 70)
    print("🚀 Running ContentFactory Performance Benchmark 🚀")
