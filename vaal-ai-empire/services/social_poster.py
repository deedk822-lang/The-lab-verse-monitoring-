...
class SocialPoster:
    ...
    def post_via_ayrshare(self, content: str, platforms: List[str], image_url: Optional[str] = None) -> Dict:
        ...
        try:
            response = requests.post(f"{self.ayrshare_url}/post", headers=headers, json=payload, timeout=30)
    ...
    def post_via_socialpilot(self, content: str, platforms: List[str], image_url: Optional[str] = None) -> Dict:
        ...
        for platform in platforms:
            ...
            try:
                response = requests.post(f"{self.socialpilot_url}/posts", headers=headers, json=payload, timeout=30)
    ...
    def get_post_analytics(self, post_id: str, platform: str) -> Dict:
        ...
        if self.providers["ayrshare"]:
            ...
            try:
                response = requests.get(f"{self.ayrshare_url}/post/{post_id}", headers=headers, timeout=15)
